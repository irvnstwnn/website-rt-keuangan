  ...
  return (
    <div className="bg-white">
      <div className="flex justify-end">
        <button
          type="button"
          onClick={() => navigate("/dashboardbendahara/keuangan/add")}
          class="bg-green-500 text-white font-bold py-1 px-5 rounded-md hover:bg-green-600"
        >
          Tambah Data
        </button>
      </div>
      <table className="min-w-full shadow-md rounded-lg divide-y mt-3 divide-gray-200">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {data.map((item, index) => (
            <tr key={item.id}>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                {format(item.tanggal.toDate(), "dd/MM/yyyy")}
              </td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                {item.keterangan}
              </td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                <button
                  ...
                  onClick={() =>
                    navigate(`/dashboardbendahara/keuangan/${item.id}`)
                  }
                >
                  Edit
                </button>
          ...
          <tr>
            <td
              className="px-6 py-4 whitespace-nowrap text-sm text-center text-primary"
              colSpan={4}
            >
              Total Pemasukan
            </td>
